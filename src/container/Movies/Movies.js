...
const mapDispatchToProps = dispatch=>{
    return {
        ...
        onMovieSearch : (searchTerm) => dispatch(actionCreators.searchMovies(searchTerm)),
        onFetchMoreData : (searchTerm,page) => dispatch(actionCreators.fetchNextMovies(searchTerm,page)),
